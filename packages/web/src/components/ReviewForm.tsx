  ...
  return (
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="text-center space-y-2">
                              <div className="inline-flex items-center justify-center w-12 h-12 bg-orange-100 rounded-xl shadow-md mb-2">
        ...
        <div className="pt-4 border-t border-gray-200/50">
          <div className="flex items-center justify-between flex-nowrap">
            <div className="flex items-center space-x-1.5 text-[11px] sm:text-xs text-gray-600 bg-gray-100 px-2 py-1 sm:px-3 sm:py-1.5 rounded-full border border-gray-200 mb-4 sm:mb-0 whitespace-nowrap">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-5 sm:px-6 rounded-lg focus:outline-none focus:shadow-outline transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base whitespace-nowrap"
              >
                {isSubmitting ? (
                  ...
                  <span className="flex items-center whitespace-nowrap">
                    <svg xmlns="http://www.w3.org/2000/svg" className="hidden sm:block h-3 w-3 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
