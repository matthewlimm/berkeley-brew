...
export const PopularTimesChart: React.FC<PopularTimesChartProps> = ({ 
  ...
  // If we don't have valid hourly data or it's all zeros (mock data), show a message
      ...
      <div className="w-full popular-times-container h-[180px] flex flex-col">
        ...
        <div className="relative h-20 w-full">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-gray-400">Popular times information is not available</p>
          </div>
        </div>
        ...
        {/* Footer text to match chart view */}
