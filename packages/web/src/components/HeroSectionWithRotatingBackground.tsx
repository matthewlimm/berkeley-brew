        ...
        <div className="bg-black bg-opacity-70 rounded-lg px-4 py-2 shadow-md">
          <div className="flex flex-col space-y-1">
            ...
            <div className="text-xs text-gray-300">
              Photo by <a href={currentImage.photographerUrl} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">{currentImage.photographer}</a> on <a href={currentImage.unsplashUrl} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">Unsplash</a>
            </div>
          </div>
        </div>
      </div>
