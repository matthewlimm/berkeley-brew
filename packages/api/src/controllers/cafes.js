...
const getAllCafes = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const isCurrentlyOpen = (businessHours) => {
            ...
            const todayPeriod = businessHours.periods.find((period) => period.open && period.open.day === currentDay);
        ...
        const cafesWithAvgRating = cafes.map((cafe) => {
            ...
            if (updatedBusinessHours) {
                updatedBusinessHours = Object.assign(Object.assign({}, updatedBusinessHours), { open_now: isCurrentlyOpen(updatedBusinessHours) });
            }
            return Object.assign(Object.assign({}, cafe), { business_hours: updatedBusinessHours, average_rating: avgRating, review_count: reviews.length });
        });
        res.status(200).json({
            status: 'success',
            data: {
...
const getCafeById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(200).json({
            status: 'success',
            data: {
                cafe: Object.assign(Object.assign({}, cafe), { average_rating: avgRating, review_count: reviews.length })
            }
        });
    }
    catch (err) {
...
const addCafeReview = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        try {
            ...
            const { data: insertedReview, error } = yield anonClient
                .from('reviews')
                .insert({
                cafe_id: cafeId,
                user_id: user.id,
